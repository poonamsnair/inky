export const DOODLE_STYLE_PROFILES = {
  "bold-ink-character": {
    ...
    optionalLibraries: {
      ...
      imagePaths: "extract structural contour candidates with window.inky.extractPathsFromImage() before assigning semantic meaning",
  ...
  "striped-fashion-doodle": {
    ...
    optionalLibraries: {
      ...
      imagePaths: "extract garment silhouettes, stripe direction, tool pockets, hands, and shoe contours from references",
  ...
  "doodle-wall-studio": {
    ...
    optionalLibraries: {
      ...
      imagePaths: "find poster boundaries, page rectangles, laptop shapes, and repeated background contour groups",
  ...
  "inky-portrait-doodle": {
    ...
    optionalLibraries: {
      ...
      imagePaths: "extract face, glasses, hair, shirt, and shoulder contours from portrait references",
...
export function buildDoodleToolBrief(profileName, options = {}) {
  ...
  return {
    ...
    styleChecks: [
      ...
      "Use extracted image paths as contour hints, not visible final layers.",
