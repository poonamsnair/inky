...
Create an animated illustration style script with captions. Use a black-and-white pen ink storyboard drawing style.
...
|---|---|---|---|---|
| 1 | `projects/inky-promo/storyboard/frame-00.png` | not-started | first-frame-anchor | |
| 2 | `projects/inky-promo/storyboard/frame-01.png` | not-started | pending | |
| 3 | `projects/inky-promo/storyboard/frame-02.png` | not-started | pending | |
| 4 | `projects/inky-promo/storyboard/frame-03.png` | not-started | pending | |
| 5 | `projects/inky-promo/storyboard/frame-04.png` | not-started | pending | |
| 6 | `projects/inky-promo/storyboard/frame-05.png` | not-started | pending | |
| 7 | `projects/inky-promo/storyboard/frame-06.png` | not-started | pending | |
| 8 | `projects/inky-promo/storyboard/frame-07.png` | not-started | pending | |
| 9 | `projects/inky-promo/storyboard/frame-08.png` | not-started | pending | |
| 10 | `projects/inky-promo/storyboard/frame-09.png` | not-started | pending | |
| 11 | `projects/inky-promo/storyboard/frame-10.png` | not-started | pending | |
| 12 | `projects/inky-promo/storyboard/frame-11.png` | not-started | pending | |
