...
|---|---|---|---|---|
| 1 | `projects/leafy-plant-rescue-comic/storyboard/frame-00.png` | not-started | first-frame-anchor | |
| 2 | `projects/leafy-plant-rescue-comic/storyboard/frame-01.png` | not-started | pending | |
| 3 | `projects/leafy-plant-rescue-comic/storyboard/frame-02.png` | not-started | pending | |
| 4 | `projects/leafy-plant-rescue-comic/storyboard/frame-03.png` | not-started | pending | |
| 5 | `projects/leafy-plant-rescue-comic/storyboard/frame-04.png` | not-started | pending | |
| 6 | `projects/leafy-plant-rescue-comic/storyboard/frame-05.png` | not-started | pending | |
| 7 | `projects/leafy-plant-rescue-comic/storyboard/frame-06.png` | not-started | pending | |
| 8 | `projects/leafy-plant-rescue-comic/storyboard/frame-07.png` | not-started | pending | |
| 9 | `projects/leafy-plant-rescue-comic/storyboard/frame-08.png` | not-started | pending | |
| 10 | `projects/leafy-plant-rescue-comic/storyboard/frame-09.png` | not-started | pending | |
| 11 | `projects/leafy-plant-rescue-comic/storyboard/frame-10.png` | not-started | pending | |
| 12 | `projects/leafy-plant-rescue-comic/storyboard/frame-11.png` | not-started | pending | |
