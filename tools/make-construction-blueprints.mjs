...
function defaultBlueprint(key) {
  ...
  return {
    ...
    lighthouseUse: [
      ...
      "When exact contour placement matters, call window.inky.extractPathsFromImage() in preview and redraw the returned coordinates with Inky brushes.",
      "Use the current project requirements for requested changes and recurring design anchors.",
      "Do not paste, hide, or preserve source pixels/details that conflict with the requirements.",
    ],
    attachmentChains: [
