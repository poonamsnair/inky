...
<html lang="en">
  ...
  <body>
    ...
    <script type="module">
      ...
      card("Irregular chunks", "Wobbly path points, no external package required.", 50, 130, 360, 180);
      ...
      card("Atrament replay", "Captured handwriting strokes can be replayed as Inky brush points.", 870, 130, 360, 180);
      replayAtramentStroke(
        ctx,
        {
          weight: 5,
      ...
      card("p5.brush standalone", "Natural media marks on a separate canvas, then composited.", 50, 370, 360, 180);
      try {
      ...
      card("Agent choice", "These tools are companions, not mandatory styles.", 870, 370, 360, 180);
      const agentPen = createBrush({ type: "agent-pen", color: "#17120d", size: 3, jitter: 0.25, thinning: 0.5, seed: 88 });
      agentPen.stroke(ctx, [
        [914, 474],
        [970, 424],
        [1022, 486],
